...
<nav class="navbar navbar-expand-md">
    <div class="d-md-none background-white">
        <a href='/' title="PSTCL LOGO" class="background-white">
            <img src='images/logo/pstcllogo.png' id="usrPnlLogo" alt="PSTCL" title="PSTCL" height="70" width="80" />
        </a>
    </div>
        ...
        <ul class="navbar-nav">
            ...
            <li class="nav-item dropdown">
                ...
                <div class="dropdown-menu" aria-labelledby="Preview">
                    ...
                    <a class="dropdown-item" href="downloads/UFRs_Data_june_19.xlsx">Healthiness of UFRs (Pb.)</a>
...
<a class=" dropdown-item" href="bill.aspx">STU/SLDC Bill</a>
            ...
            <li class="nav-item">
                <a class="nav-link" href="./windSolar.aspx">Wind/Solar</a>
            </li>
