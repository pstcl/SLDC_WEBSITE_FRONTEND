    ...
    <div class="collapse navbar-collapse" id="nav-content">
        <ul class="navbar-nav">
            ...
            <li class="nav-item dropdown">
                ...
                <div class="dropdown-menu" aria-labelledby="Preview">
                    ...
                    <a class="dropdown-item"
                        href="http://103.7.128.190/wbes/ReportNetSchedule/GetNetScheduleIndex">State Drawl
                        Schedules</a>
                    <a class="dropdown-item"
                        href="https://distribution.pspcl.in/returns/module.php?to=NRLDC.powerSummary">Punjab Power
                        Summary</a>
                </div>
            </li>
            <li class="nav-item dropdown">
           ...
           <li class="nav-item dropdown">
                ...
                <div class="dropdown-menu" aria-labelledby="Preview">
                     <a href="downloads/atc-ttc.pdf">ATC/TTC (Pb.)</a>
					<a href="downloads/UFRs_Data.xlsx">Healthiness of UFRs (Pb.)</a>
                    <a href="">Presentations</a>
                    <a href="image_gallery.aspx">Photo Gallery</a>
                    <a href="downloads/emergency-contact.pdf">Emergency Contact Nos.</a>
                    <a href="downloads/restoration-proc.pdf">Restoration Procedure</a>
            ...
            <li class="nav-item dropdown">
                ...
                <div class="dropdown-menu" aria-labelledby="Preview">
                    <a class="dropdown-item" href="http://www.punjabsldc.org/oldsite/News/list%20of%20emails.pdf">List
                        of
                        e-mail IDs</a>
                </div>
            </li>
