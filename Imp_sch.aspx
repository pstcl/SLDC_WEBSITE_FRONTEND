...
<asp:Content ID="Content1" ContentPlaceHolderID="ContentPlaceHolder1" Runat="Server">
   <center>  <div class="PostMetadataHeader">
 ...
 <div class="PostContent">
	...
	<SCRIPT language="Javascript"  type="text/javascript">
     ...
     <center>    <form name="mainForm" action="" method="post" >                            		                               
					<p> <br>  </p>
							...
							<table valign="center"  cellspacing = 8 >							    
									...
									<option value="Jan2019">Jan 2019<option value="Feb2019">Feb 2019<option value="Mar2019">Mar 2019<option value="Apr2019">Apr 2019<option value="May2019">May 2019
									</select>
                                    &nbsp;
                                    </td>
    ...
    <br /><br />
    <center> 
<p>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp; &nbsp;&nbsp;&nbsp;&nbsp; &nbsp;<input type="button" value="View Implementation Schedule" style="width:150;font-family:Verdana;font-size:13px;font-weight:bold" onclick = "javascript:openWin();" id=button1 name=button1></p>
    </center>
